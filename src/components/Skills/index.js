    ...
    <div className="Skills">
      <div className="d-flex">
        <div className="flex-row skill-top animation-right">
          ...
          <span className="badge badge-shadow bg-light text-dark"><div><i className="devicon-postgresql-plain-wordmark colored"></i></div>Postgresql</span>
          ...
          <span className="badge badge-shadow bg-light text-dark"><div><i className="devicon-ruby-plain-wordmark colored"></i></div>Ruby</span>
        </div>
        <div className="flex-row skill-bottom animation-left justify-content-end">
          <span className="badge badge-shadow bg-light text-dark"><div><i className="devicon-rails-plain-wordmark colored"></i></div>Rails</span>
